    ...
    <?php
        if(isset($GLOBALS['view']['connected']) && $GLOBALS['view']['connected']){
           ...
           ?>
            <nav class="menu">
                <ul>
                    <li class ="logo"><a href="<?php echo $GLOBALS['server_root'] . '/user/dashboard'?>"><img class="logo" src="<?php echo $GLOBALS['server_root']?>/ressources/img/logo hk blanc_redim.png"></a></li>
